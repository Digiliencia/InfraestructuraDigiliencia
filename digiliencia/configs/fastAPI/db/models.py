...
class Chat(Base):
    ...
    user_id = Column(UUID(as_uuid=True), ForeignKey("usuario.id"), nullable=False)
    
    owner = relationship("User", back_populates="chats")
    messages = relationship("Message", back_populates="chat", cascade="all, delete-orphan")
    prompts = relationship("IAPrompt", secondary=chat_iaprompt_association, back_populates="chats")
...
class IAPrompt(Base):
    ...
    chats = relationship("Chat", secondary=chat_iaprompt_association, back_populates="prompts")
