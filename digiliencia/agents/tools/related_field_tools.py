...
TOOLS = [
    {"name": "list_related_field_categories", "callable": list_related_field_categories, "description": "Lista nombres de categorías."},
    {"name": "list_all_related_fields", "callable": list_all_related_fields, "description": "Lista todos los valores de related fields."},
    {"name": "check_related_field_exists", "callable": check_related_field_exists, "description": "Verifica si un valor existe como nodo (name)."},
    {"name": "missing_related_fields", "callable": missing_related_fields, "description": "Devuelve los valores que faltan en Neo4j."},
]
