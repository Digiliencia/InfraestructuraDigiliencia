...
def create_mock_response(json_return_value=None, raise_for_status_effect=None, json_side_effect=None):
...
def test_classify_news_topics_success(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_with_max_topics_limit(topic_classification_service, mock_news, monkeypatch):
    """Test that max_topics limit is respected."""
    # Mock response with more topics than max_topics
    mock_response = create_mock_response(
        json_return_value={"response": '["Artificial Intelligence", "Cybersecurity", "Data Privacy", "Cloud Computing"]'}
    )
...
def test_classify_news_topics_invalid_topic_names(topic_classification_service, mock_news, monkeypatch):
    """Test handling of invalid topic names in response."""
    # Mock response with invalid topic names
    mock_response = create_mock_response(
        json_return_value={"response": '["Artificial Intelligence", "Invalid Topic", "Cybersecurity"]'}
    )
...
def test_classify_news_topics_connection_error(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_timeout_error(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_http_error(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_missing_response_field(topic_classification_service, mock_news, monkeypatch):
    """Test handling of missing 'response' field in Ollama response."""
    mock_response = create_mock_response(
        json_return_value={"error": "Some error"}
    )
...
def test_classify_news_topics_empty_response(topic_classification_service, mock_news, monkeypatch):
    """Test handling of empty response."""
    mock_response = create_mock_response(
        json_return_value={"response": ""}
    )
...
def test_classify_news_topics_invalid_json_response(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_non_list_response(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_json_decode_error(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_unexpected_error(topic_classification_service, mock_news, monkeypatch):
...
def test_classify_news_topics_with_whitespace_in_response(topic_classification_service, mock_news, monkeypatch):
