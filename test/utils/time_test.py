...
def test_format_days_ago_negative_value():
...
def test_format_days_ago_seven_or_more_days_windows(mock_platform, mock_datetime):
...
def test_format_days_ago_seven_or_more_days_unix(mock_platform, mock_datetime):
...
def test_days_between_dates_relative_dates(mocker):
...
def test_days_between_dates_now(mocker):
...
def test_days_between_dates_formatted_dates_windows(mock_platform):
...
def test_days_between_dates_formatted_dates_unix(mock_platform):
...
def test_days_between_dates_invalid_relative_format():
...
def test_days_between_dates_invalid_absolute_format():
...
def test_days_between_dates_error_parsing_first_date():
...
def test_format_spanish_date(mock_datetime):
...
def test_days_between_es_dates_no_format_matched():
...
def test_format_subtract_days_to_actual_date_zero_days(mock_datetime):
...
def test_format_subtract_days_to_actual_date_with_days(mock_datetime):
...
def test_format_days_ago_large_number(mock_datetime):
...
def test_format_spanish_date_zero_days(mock_datetime):
...
def test_days_between_dates_continue_loop_formats(mock_platform):
...
def test_days_between_dates_continue_loop_formats_unix(mock_platform):
...
def test_days_between_es_dates_continue_loop_formats():
